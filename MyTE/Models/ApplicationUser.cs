...
namespace MyTE.Models
{
...

    {
        ...
        [RegularExpression(@"^[a-zA-Z\s\u00C0-\u017F]*$", ErrorMessage = "O Nome não deve conter números ou caracteres especiais.")]
        [Display(Name = "Nome")]
        ...
        [RegularExpression(@"^[a-zA-ZÀ-ú\s]*$", ErrorMessage = "O Sobrenome não deve conter números ou caracteres especiais.")]
